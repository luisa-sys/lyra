...
- Current test floor: **3635 tests** (278 suites) in lyra (unit + scripts; E2E + integration not counted), **733 tests** (44 suites) in lyra-mcp-server. lyra count is **cited, not independently re-run, from SEC-132's own PR #764 commit message** (`develop` HEAD `9bba3a4a`, 2026-08-12: "Full suite green: 278 suites / 3635 tests"), 5 up from the prior 3630/278 measured earlier the same day at `62db86b` (SEC-104) — consistent with net-new coverage added by SEC-130/131/132, not a deletion. lyra-mcp-server unchanged at 733/44 (still `main` `10406a0`, 2026-08-12, no new commits since). Re-measure and update this line whenever it drifts — a floor far below reality cannot detect a regression that deletes hundreds of tests. (Previously 3630/278 measured 2026-08-12 at `62db86b`; 3544/273 measured 2026-08-10 on `feat/kan-415-d6-age-auth`; 3113/257 measured 2026-08-09 on PR #715; 2705/234 2026-08-01; 2659/225 2026-07-31; 2611/222 2026-07-28 under KAN-435; before that, 2118/172 and 91/5, both years of work stale.)
