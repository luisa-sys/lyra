...
- Current test floor: **3544 tests** (273 suites) in lyra (unit + scripts; E2E + integration not counted), **734 tests** (44 suites) in lyra-mcp-server. **Measured 2026-08-10** locally on `feat/kan-415-d6-age-auth` (KAN-415 D6) — re-read it off the next green CI run and correct it if they differ. The `lyra-mcp-server` figure is **unchanged and not re-measured** — last taken 2026-08-01 on main `31c114b` via `npx tsc && npm test`; re-measure it before relying on it. Re-measure and update this line whenever it drifts — a floor far below reality cannot detect a regression that deletes hundreds of tests. (Previously 3113/257 measured 2026-08-09 on PR #715; 2705/234 2026-08-01; 2659/225 2026-07-31; 2611/222 2026-07-28 under KAN-435; before that, 2118/172 and 91/5, both years of work stale.)
