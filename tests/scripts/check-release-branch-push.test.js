/**
 * CTL-063 / SEC-99 — no repo-committed script pushes to a release branch.
 *
 * WHAT THIS PROTECTS
 * ------------------
...
describe('CTL-063 — the checker exists and is wired in', () => {
...
describe('CTL-063 — the estate is clean, and the deleted scripts stay deleted', () => {
...
describe('CTL-063 — behaviour, driven through the real script', () => {
