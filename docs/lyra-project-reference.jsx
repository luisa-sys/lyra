...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "DSN", value: "https://7ce4583403ac31941f4c5b06c8abddd2@o4511605710127104.ingest.de.sentry.io/4511605735424080", copy: true },
      { label: "Org ID", value: "o4511605710127104 (numeric, in DSN)" },
      { label: "Project ID", value: "4511605735424080 (numeric, in DSN)" },
  ...
  },
  {
    ...
    icon: "🔄",
    items: [
      { label: "Flow", value: "develop → staging → beta → main (production)" },
      { label: "Dev deploy workflow", value: "deploy-dev.yml (on push to develop)" },
      { label: "Promote to staging", value: "gh workflow run promote-to-staging.yml -f confirm=promote" },
      { label: "Promote to beta", value: "gh workflow run promote-staging-to-beta.yml -f confirm=promote" },
      { label: "Promote to production", value: "gh workflow run promote-to-production.yml -f confirm=PRODUCTION (manual, Luisa's sign-off)" },
